...
(function(ga) {
    ...
    function D(b, c) { for (var d in b) if (x(b, d) && c(b[d], d)) break }
    ...
    function ma(b) {
        ...
        function d(a) {
            E &&
                y(document.getElementsByTagName("script"),
                    function(n) {
                        if (n.getAttribute("data-requiremodule") === a &&
                            n
                            .getAttribute("data-requirecontext") ===
                            l.contextName) return n.parentNode.removeChild(n), !0
                    })
        }
        ...
        function q(a, n, b, h) {
            ...
            (d
                ? m = f && f.normalize
                ? f.normalize(a, function(a) { return c(a, g, h) })
                : -1 === a.indexOf("!") ? c(a, g, h) : a
        ...
        function A(a, b) {
            ...
            if (b) b(a);
            else if (y(c, function(b) { if (b = e(t, b)) b.error = a, b.events.error && (h = !0, b.emit("error", a)) }),
                !h) g.onError(a)
        }
        ...
        function H() {
            ...
            if (!aa) {
                ...
                if (c && h.length)
                    return a = F("timeout", "Load timeout for modules: " + h, null, h), a.contextName = l.contextName,
                        A(a);
            ...
            module: function(a) {
                return a.module
                    ...
                    : a.module = {
                        id: a.map.id,
                        uri: a.map.url,
                        config: function() { return e(p.config, a.map.id) || {} },
                ...
                if (!this.fetched) {
                    ...
                    if (this.shim)
                        l.makeRequire(this
                            ...
                            z(this, function() { return a.prefix ? this.callPlugin() : this.load() }));
                    ...
                    if (!this.inited) x(l.defQueueMap, c) || this.fetch();
                        ...
                        if (1 > this.depCount && !this.defined) {
                            if (K(k)) {
                                ...
                                if (a)
                                    return a.requireMap = this
                                        .map, a
                                        .requireModules = this.map
                                        .isDefine
                                        ? [this.map.id]
                                        : null, a
                                        .requireType = this.map.isDefine ? "define" : "require", A(this.error = a)
                            } else h = k;
                            this.exports = h;
                    ...
                    z(this,
                        function(h) {
                            ...
                            if (this.map.unnormalized) {
                                if (h.normalize &&
                                (M = h.normalize(M, function(a) { return c(a, r, !0) }) ||
                    ...
                    z(this,
                        function(a,
                            ...
                            if ("string" === typeof a) {
                                ...
                                w(a,
                                    "defined",
                                    z(this, function(a) { this.undefed || (this.defineDep(b, a), this.check()) }));
                                this.errback
                                    ? w(a, "error", z(this, this.errback))
                                    : this.events.error && w(a, "error", z(this, function(a) { this.emit("error", a) }))
                            }
                            c = a.id;
                            h = t[c];
            ...
            makeRequire: function(a, n) {
                ...
                Y(m,
                {
                    ...
                    toUrl: function(b) {
                        ...
                        -1 !== f &&
                            ("." !== g && ".." !== g || 1 < f) &&
                            (d = b.substring(f, b.length), b = b.substring(0,
                                f));
            ...
            onScriptError: function(a) {
                ...
                if (!m(b.id)) {
                    ...
                    D(t,
                        function(a, d) {
                            0 !== d.indexOf("_@r") &&
                                y(a.depMaps, function(a) { if (a.id === b.id) return c.push(d), !0 })
                        });
                    return A(F("scripterror",
            ...
            X(document.getElementsByTagName("script"),
                function(b) {
                    ...
                    if (O = b.getAttribute("data-main"))
                        return u = O, w.baseUrl ||
                            -1 !== u.indexOf("!") ||
                            (I = u.split("/"), u = I
                                .pop(), T = I.length ? I.join("/") + "/" : "./", w.baseUrl = T), u = u.replace(U, ""), g
                            .jsExtRegExp
                            .test(u) &&
                            (u = O), w.deps = w.deps ? w.deps.concat(u) : [u], !0
                });
        define = function(b, c, d) {
            ...
            !c &&
                ...
                (d
                    .toString()
                    .replace(qa, ka)
                    .replace(ra, function(b, d) { c.push(d) }), c = (
                    1 === d.length ? ["require"] : ["require", "exports", "module"]).concat(c)));
            S &&
                (e = P || pa()) &&
