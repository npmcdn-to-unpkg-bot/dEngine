...
namespace dEngine.Instances
{
    ...
    {
        public static readonly Vector3int16[] CornerIndex =
        {
            new Vector3int16(0, 0, 0),
            new Vector3int16(1, 0, 0),
            new Vector3int16(0, 0, 1),
            new Vector3int16(1, 0, 1),
            new Vector3int16(0, 1, 0),
            new Vector3int16(1, 1, 0),
            new Vector3int16(0, 1, 1),
            new Vector3int16(1, 1, 1)
        };
        ...
        public static readonly RegularCell[] TransitionRegularCellData =
        {
            ...
            new RegularCell(0xCC,
                new byte[]
                {
                    0, 1, 9, 1, 8, 9, 1, 2, 8, 2, 11, 8, 2, 3, 11, 3, 4, 11, 4, 5, 11, 5, 10, 11, 5, 6, 10, 6, 9, 10, 6,
                    7, 9, 7, 0, 9
                }),
        ...
        {
            private readonly byte geometryCounts; // High nibble is vertex count, low nibble is triangle count.
            private readonly byte[] vertexIndex; // Groups of 3 indexes giving the triangulation.
