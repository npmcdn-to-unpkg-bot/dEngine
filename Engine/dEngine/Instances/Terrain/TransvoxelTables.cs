...
namespace dEngine.Instances
{
	...
	internal static class TransvoxelTables
	{
		...
		{
			readonly byte geometryCounts; // High nibble is vertex count, low nibble is triangle count.
			readonly byte[] vertexIndex; // Groups of 3 indexes giving the triangulation.
