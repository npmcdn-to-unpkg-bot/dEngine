	...
	public sealed class LuaAction<T1>
	{
		...
		public static implicit operator LuaAction<T1>(Func<object, object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1>(del);
				...
				/// <summary/>
		public static implicit operator LuaAction<T1>(Func<object, object, object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1>(del);
		}
	...
	public sealed class LuaAction<T1, T2>
	{
		...
		public static implicit operator LuaAction<T1, T2>(Func<object, object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2>(del);
				...
				/// <summary/>
		public static implicit operator LuaAction<T1, T2>(Func<object, object, object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2>(del);
		}
	...
	public sealed class LuaAction<T1, T2, T3>
	{
		...
		public static implicit operator LuaAction<T1, T2, T3>(Func<object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3>(del);
				...
				/// <summary/>
		public static implicit operator LuaAction<T1, T2, T3>(Func<object, object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3>(del);
		}
				/// <summary/>
		public static implicit operator LuaAction<T1, T2, T3>(Func<object, object, object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3>(del);
		}
	...
	public sealed class LuaAction<T1, T2, T3, T4>
	{
		...
		public static implicit operator LuaAction<T1, T2, T3, T4>(Func<object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3, T4>(del);
				...
				/// <summary/>
		public static implicit operator LuaAction<T1, T2, T3, T4>(Func<object, object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3, T4>(del);
		}
				/// <summary/>
		public static implicit operator LuaAction<T1, T2, T3, T4>(Func<object, object, object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3, T4>(del);
		}
	...
	public sealed class LuaAction<T1, T2, T3, T4, T5>
	{
		...
		public static implicit operator LuaAction<T1, T2, T3, T4, T5>(Func<object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3, T4, T5>(del);
				...
				/// <summary/>
		public static implicit operator LuaAction<T1, T2, T3, T4, T5>(Func<object, object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3, T4, T5>(del);
		}
				/// <summary/>
		public static implicit operator LuaAction<T1, T2, T3, T4, T5>(Func<object, object, object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3, T4, T5>(del);
		}
	...
	public sealed class LuaAction<T1, T2, T3, T4, T5, T6>
	{
		...
		public static implicit operator LuaAction<T1, T2, T3, T4, T5, T6>(Func<object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3, T4, T5, T6>(del);
				...
				/// <summary/>
		public static implicit operator LuaAction<T1, T2, T3, T4, T5, T6>(Func<object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3, T4, T5, T6>(del);
		}
				/// <summary/>
		public static implicit operator LuaAction<T1, T2, T3, T4, T5, T6>(Func<object, object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3, T4, T5, T6>(del);
				...
				/// <summary/>
		public static implicit operator LuaAction<T1, T2, T3, T4, T5, T6>(Func<object, object, object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3, T4, T5, T6>(del);
		}
	...
	public sealed class LuaAction<T1, T2, T3, T4, T5, T6, T7>
	{
		...
		public static implicit operator LuaAction<T1, T2, T3, T4, T5, T6, T7>(Func<object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3, T4, T5, T6, T7>(del);
				...
				/// <summary/>
		public static implicit operator LuaAction<T1, T2, T3, T4, T5, T6, T7>(Func<object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3, T4, T5, T6, T7>(del);
		}
				/// <summary/>
		public static implicit operator LuaAction<T1, T2, T3, T4, T5, T6, T7>(Func<object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3, T4, T5, T6, T7>(del);
		}
				/// <summary/>
		public static implicit operator LuaAction<T1, T2, T3, T4, T5, T6, T7>(Func<object, object, object, object, object, LuaResult> del)
		{
			return new LuaAction<T1, T2, T3, T4, T5, T6, T7>(del);
		}
				/// <summary/>
