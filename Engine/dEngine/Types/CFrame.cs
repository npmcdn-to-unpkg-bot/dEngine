...
namespace dEngine
{
    ...
    public struct CFrame : IDataType, IEquatable<CFrame>, IListenable
    {
        ...
        public CFrame inverse()
        {
            ...
            var num1 = (float)(M31*(double)M42 - M32*(double)M41);
            var num2 = (float)(M31*(double)M43 - M33*(double)M41);
            var num3 = (float)(M34*(double)M41 - M31*(double)M44);
            var num4 = (float)(M32*(double)M43 - M33*(double)M42);
            var num5 = (float)(M34*(double)M42 - M32*(double)M44);
            var num6 = (float)(M33*(double)M44 - M34*(double)M43);
            var num7 = (float)(M22*(double)num6 + M23*(double)num5 + M24*(double)num4);
            var num8 = (float)(M21*(double)num6 + M23*(double)num3 + M24*(double)num2);
            var num9 = (float)(M21*-(double)num5 + M22*(double)num3 + M24*(double)num1);
            var num10 = (float)(M21*(double)num4 + M22*-(double)num2 + M23*(double)num1);
            var num11 = (float)(M11*(double)num7 - M12*(double)num8 + M13*(double)num9 - M14*(double)num10);

            if (Math.Abs(num11) == 0.0)
                return Identity;

            var num12 = 1f/num11;
            var num13 = (float)(M11*(double)M22 - M12*(double)M21);
            var num14 = (float)(M11*(double)M23 - M13*(double)M21);
            var num15 = (float)(M14*(double)M21 - M11*(double)M24);
            var num16 = (float)(M12*(double)M23 - M13*(double)M22);
            var num17 = (float)(M14*(double)M22 - M12*(double)M24);
            var num18 = (float)(M13*(double)M24 - M14*(double)M23);
            var num19 = (float)(M12*(double)num6 + M13*(double)num5 + M14*(double)num4);
            var num20 = (float)(M11*(double)num6 + M13*(double)num3 + M14*(double)num2);
            var num21 = (float)(M11*-(double)num5 + M12*(double)num3 + M14*(double)num1);
            var num22 = (float)(M11*(double)num4 + M12*-(double)num2 + M13*(double)num1);
            var num23 = (float)(M42*(double)num18 + M43*(double)num17 + M44*(double)num16);
            var num24 = (float)(M41*(double)num18 + M43*(double)num15 + M44*(double)num14);
            var num25 = (float)(M41*-(double)num17 + M42*(double)num15 + M44*(double)num13);
            var num26 = (float)(M41*(double)num16 + M42*-(double)num14 + M43*(double)num13);
            M11 = num7*num12;
            M12 = -num19*num12;
            M13 = num23*num12;
            M21 = -num8*num12;
        ...
        /// <summary>
        /// Returns a <see cref="Vector3" />  rotated from World to Object coordinates.Equivalent to `(CFrame - CFrame.p):inverse()
        /// * v3`
        /// </summary>
        ...
        {
            var f = GetComponents();
            return new LuaTuple<float, float, float, float, float, float, float, float, float, float, float, float>(
