// MeshImportViewModel.cs - dEditor
...
using dEditor.Modules.Dialogs.ModelImport;
using dEditor.Modules.Widgets.Properties;

namespace dEditor.Modules.Dialogs.MeshImport
{
    [Export(typeof(IMeshImport))]
    public class MeshImportViewModel : Conductor<PropertiesViewModel>, IMeshImport
    {
        private string _filePath;
        public PropertiesViewModel Properties;

        public MeshImportViewModel(ContentManager.ImportContext context)
        {
