...
namespace dEditor.Modules.Dialogs.NewPlace
{
    public class NewPlaceViewModel : Screen, IDataErrorInfo
    {
        ...
        internal static void LoadBaseplate()
        {
            ...
            Game.Workspace.CurrentCamera.CFrame = new CFrame(0.321689844f, 18.2346153f, 23.7645969f, 0.98357147f,
                -0.0819535926f, 0.160844535f, -0, 0.891008377f, 0.453987002f, -0.180519685f, -0.446528673f, 0.876370251f);
        }
